...
class Instructor:
    '''store information of instructor'''
...
class Repository:
    '''use list to store instructors and students information, use two dictionary, the former one's key is students' ID, value is all the grades this students have, 
     the later one is a defaultdic to ount how many people in this class.'''
...
def read_file(file_path, pattern):
    ''' read all the file and judge if the file missing information'''
...
def main():
    ''' read the file, judge the path exist or not and create pretty table '''
       
    path = 'C:\\Users\\54783\\Downloads'
    ...
    if os.path.exists(path_students) and os.path.exists(path_instructors) and os.path.exists(path_grades):
